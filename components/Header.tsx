      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          ...
          <a 
            ...
            className="flex items-center space-x-2 border-l border-gray-600 pl-4 hover:bg-gray-700 rounded py-1 px-2 transition"
          ...
          >
            ...
            />
            <span className="text-sm font-medium hidden sm:block truncate max-w-[150px] text-white">
              {user.name}
            </span>
